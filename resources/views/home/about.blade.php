  ...
  <div class="container">
    ...
    <div class="row justify-content-center my-5">
      <div class="col-md-6 bg-dark text-light p-5 rounded shadow-lg">
        ...
        <p class="fs-4">With nearly every games from Action to indie and everything in-between. Enjoy our
          comment section, game updates, and great game content.</p>
        <a href="{{ route('category.index') }}" class="btn btn-outline-light">Explore <i
    ...
    <div class="row">
      <div class="col-md-6">
        ...
        <p class="fs-3">Meet new people to play you favorite games, show and talk about you experiences! the fun
          never stops.</p>
    ...
    <div class="container p-5 d-flex flex-column justify-content-center align-items-center">
      ...
      <div class="col-md-8 row my-5">
        <div class="col-md-4 d-flex flex-column justify-content-center align-items-center">
          ...
          <h3>Community</h3>
          <p class="">A fast growing community, new comments and discussions in every game for any topic you
            can imagine!</p>
        </div>
        <div class="col-md-4 d-flex flex-column justify-content-center align-items-center">
          <i class="fa-solid fa-plus fs-1"></i>
          <h3>Variety</h3>
          <p class="">Adding games every day to improve and grow our catalog, and constantly updating
            allready added games!</p>
        </div>
        <div class="col-md-4 d-flex flex-column justify-content-center align-items-center">
      ...
      <div class="col-md-8 row my-5">
        <div class="col-md-4 d-flex flex-column justify-content-center align-items-center">
          ...
          <p class="">Easy access, have your entire catalog of games in a single place, no needs for other
            apps or sites!</p>
        </div>
        <div class="col-md-4 d-flex flex-column justify-content-center align-items-center">
          <i class="fa-solid fa-star fs-1"></i>
          <h3>status</h3>
          <p class="">Game status displayed, with how many people are currently playing and allways updating
            most recomended games for you!</p>
        </div>
        <div class="col-md-4 d-flex flex-column justify-content-center align-items-center">
